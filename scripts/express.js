...
var BufferStream = require('./lib/buffer-stream.js')
...
app.get('/api/issue/:id', function (req, res) {
  var issuemd = global.issuemd = requireFresh('../src/issuemd/core.js').default
  requireFresh('../src/issuemd/plugins/issuemd-github.js')
  requireFresh('../src/issuemd/plugins/issuemd-chance.js')

  var out
  var issue = issuemd().chance(1, req.params.id)
